...
class CreateBusRouteRequest(BaseModel):
    ...
    type_name: Annotated[str, Field(alias="typeName", max_length=10, regex=r"^(일반형|직행좌석형)시내버스$")]
    start_stop_id: Annotated[int, Field(alias="start", ge=1)]
    end_stop_id: Annotated[int, Field(alias="end", ge=1)]
    up_first_time: Annotated[datetime.time, Field(alias="upFirstTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    up_last_time: Annotated[datetime.time, Field(alias="upLastTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    down_first_time: Annotated[datetime.time, Field(alias="downFirstTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    down_last_time: Annotated[datetime.time, Field(alias="downLastTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    ...
    company_telephone: Annotated[
        str, Field(alias="companyTelephone", max_length=20, regex=r"^[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}$")]
...
class UpdateBusRouteRequest(BaseModel):
    ...
    type_name: Annotated[Optional[str], Field(alias="typeName", max_length=10, regex=r"^(일반형|직행좌석형)시내버스$")]
    ...
    up_first_time: Annotated[
        Optional[datetime.time], Field(alias="upFirstTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    up_last_time: Annotated[
        Optional[datetime.time], Field(alias="upLastTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    down_first_time: Annotated[
        Optional[datetime.time], Field(alias="downFirstTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    down_last_time: Annotated[
        Optional[datetime.time], Field(alias="downLastTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    ...
    company_telephone: Annotated[
        Optional[str], Field(alias="companyTelephone", max_length=20, regex=r"^[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}$")]
...
class CreateBusStopRequest(BaseModel):
    ...
    mobile_number: Annotated[str, Field(alias="mobileNumber", max_length=5, regex=r"^[0-9]{5}$")]
...
class UpdateBusStopRequest(BaseModel):
    ...
    mobile_number: Annotated[Optional[str], Field(alias="mobileNumber", max_length=5, regex=r"^[0-9]{5}$")]
...
class CreateBusTimetableRequest(BaseModel):
    route_id: Annotated[int, Field(alias="routeID", ge=1)]
    start_stop_id: Annotated[int, Field(alias="start", ge=1)]
    weekdays: Annotated[str, Field(alias="weekdays", regex=r"^[weekdays|saturday|sunday]$")]
