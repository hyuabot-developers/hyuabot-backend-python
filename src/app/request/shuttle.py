...
class CreateShuttleHolidayRequest(BaseModel):
    date: Annotated[datetime.date, Field(alias="date", regex=r"^[0-9]{4}-[0-9]{2}-[0-9]{2}$")]
...
class CreateShuttlePeriodRequest(BaseModel):
    ...
    start: Annotated[
        datetime.datetime,
        Field(alias="start", regex=r"^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
    end: Annotated[
        datetime.datetime,
        Field(alias="end", regex=r"^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}+09:00$")]
...
class CreateShuttleRouteStopRequest(BaseModel):
    ...
    cumulative_time: Annotated[datetime.timedelta, Field(alias="cumulativeTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}$")]
...
class UpdateShuttleRouteStopRequest(BaseModel):
    ...
    cumulative_time: Annotated[
        Optional[datetime.timedelta], Field(alias="cumulativeTime", regex=r"^[0-9]{2}:[0-9]{2}:[0-9]{2}$")]
